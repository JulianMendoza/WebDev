...
{
    private static $earliestDate="Sep 15, 2013";
    private $FirstName;
    private $LastName;
    private $BirthDate;
    private $DeathDate;
    ...
    public function __construct($first, $last, $city, $birth, $death=nil)
    {
    ...
    public static function earliestDate()
    {
