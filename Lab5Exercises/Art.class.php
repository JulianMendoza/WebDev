...
class Art implements Serializable
{
    ...
    private $artist;
    private $name;
    public function __construct($date, $artist, $name)
    {
    ...
    {
        return "Date:".$this->dateCreated." Name:".$this->name;
    }
...
{
    private $medium;
    public function __construct($date, $artist, $name, $medium)
    {
    ...
    public function __toString()
    {
        return parent::__toString()." Medium: ".$this->medium;
    }
...
{
    private $weight;
    public function __construct($date, $artist, $name, $med, $weight)
    {
